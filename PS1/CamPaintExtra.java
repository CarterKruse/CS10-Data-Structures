...
public class CamPaintExtra extends Webcam
{
    ...
    private boolean paintingOn = true; // Variable for pausing/restarting painting.
        ...
        if (displayMode == 'r' || displayMode == 'p')
        {
            ...
            if (image != null && targetColor != null)
            {
                ...
                if (largestRegion != null)
                {
                    ...
                    {
                        // Checking to see if the painting should be updated/if the "brush" is down.
                        if (paintingOn)
                        {
    ...
    public void handleKeyPress(char k)
    {
        ...
        {
            // Using the space bar to pause/restart the painting.
            paintingOn = !paintingOn;
        }

        else if (k == 'l')
        {
            // Randomizing the paint color when the key l is pressed.
            paintColor = new Color((int) (Math.random() * 256), (int) (Math.random() * 256), (int) (Math.random() * 256));
        }
